...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: "2026-06-27",
    changes: [
      "「审核记录」从文件审核的子模式升级为独立的一级菜单（侧边栏新增「审核记录」入口）",
      "审核记录输出优化为三栏表格格式：审核要素/体系文件 | 检查事项和方法 | 检查或跟踪记录",
      "输出格式参考 ISMS 审核记录标准样式，包含标准要求、审核方法、审核证据、符合性判定、判定说明、改进建议",
      "后端审核记录 LLM 提示词优化，输出更贴近实务的审核记录内容",
      "App.tsx 新增 RecordIcon 组件，侧边栏菜单扩展为 4 项",
      "文件审核模块简化：移除模式切换，专注差距分析功能",
    ],
  },
  {
    version: "1.4.0",
